...
Notes from Kaitlyn:
Look only at Texas Rising Star Activity Category. Remove the words Texas Rising Star from word counts. Group by Board. Analyze Activity Description to see what most common categories of spending are. Kaitlyn will provide key words to do specific counts on by 1/10/24.
